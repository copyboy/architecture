...
class Chapter0121Test {
    ...
    void switchIntCase_match_when_given_byte() {
        byte b = 127;
        String caseWhen = Chapter0121.switchIntCase(b);
